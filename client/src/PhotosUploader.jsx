...
export default function PhotosUploader({addedPhotos, onChange}) {
    ...
    function removePhoto(ev, name) {
        ev.preventDefault();
        onChange([...addedPhotos.filter(photo => photo !== name)]);
    }
    function selectAsMainPhoto(ev, name) {
        ev.preventDefault();
        onChange([name, ...addedPhotos.filter(photo => photo !== name)]);
    }
